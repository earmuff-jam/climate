...
WITH previous_profile AS (SELECT id
                          ...
                          WHERE public.profiles.user_role = '1204'
                          ORDER BY created_on DESC
                          LIMIT 1)
INSERT
INTO properties.properties (id, title, description, property_type, address, bedrooms, bathrooms, square_footage,
                            amenities,
                            pet_policy, availability_dates, rent_amount, security_deposit, lease_term, owner_id,
                            contact_name,
...
-- TRUNCATE TABLE properties.properties;
--
-- END;
