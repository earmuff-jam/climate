...
} from "@/components/Maintenance/Hooks";
      ...
      <div className="col-span-1 md:block hidden bg-white rounded-md shadow-md p-6 w-full ">
        <form className={"flex flex-col gap-6"}>
          <Input
            ...
            name={form.name.name}
            error={form.name.errorMsg.length >= 1 ? true : false}
          ...
          <Input
            ...
            error={form.inspection_date.errorMsg.length >= 1 ? true : false}
          ...
          <Select
            ...
            onChange={(e) =>
              handleSelectInspection(e, form.inspection_type.name)
            }
          >
          ...
          <Input
            ...
            error={form.signature.errorMsg.length >= 1 ? true : false}
            onChange={handleChangeInspection}
          />
